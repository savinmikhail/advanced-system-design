## Часть 3. Распределённые транзакции: от 2PC до Saga
...
Вот тут и вылезают распределённые транзакции.
...
# Блок 3.1. Почему транзакции ломаются в микросервисах (3–4 мин)
...
# Блок 3.2. Классика: Two-Phase Commit (2PC) (4–5 мин)
...
## Блок 3.3. Three-Phase Commit (3PC) — знать идею (1 минута)
...
# Блок 3.4. Saga — как это делают нормальные системы (10–12 мин)
...
# Блок 3.5. Оркестрация против хореографии (4–5 мин)
...
# Блок 3.6. Temporal, Camunda, Conductor и прочие движки (5–6 мин)
...
# Блок 3.9. Типичные фейлы распределённых транзакций (3–5 мин)
...
# Блок 3.10. Когда Saga — плохая идея (2 мин)
...
# Блок 3.11. Альтернативы и дополнения к Saga (2–3 мин)
