...
Есть три сервиса: платежи, заказы и инвентарь.

Пользователь оплатил товар.
Деньги списались.
А заказ не создался — сеть между сервисами мигнула в самый “удачный” момент.

Дальше в логах классика жанра:

* “несогласованность данных”;
* “ручной откат платежей”;
* “сверка отчётов за день”.

И закономерный вопрос от команды и бизнеса:

> “Можно ли сделать так, чтобы данные были **всегда** согласованы,
> как будто у нас одна база и один источник истины?”

Ответ: да, можно. Это и есть strong consistency.
Но это не тумблер “включить”, а дорогая инженерная роскошь.
