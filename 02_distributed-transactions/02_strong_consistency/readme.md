...
Там нам нужна модель, где после успешной записи любое последующее чтение этого ключа видит новое значение, независимо от того, на какой узел пришёл запрос. 
Это и есть strong consistency.
