...
Когда TTL у популярного кэша истекает, много запросов одновременно получают miss и штурмуют БД что приводит к
- всплеску нагрузки, 
- росту latency, 
...
следующая типичная проблема кэша — stale data (устаревшие данные)
...
Подробнее на них останавливаться не будем. 
