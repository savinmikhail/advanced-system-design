...
Но кроме нее мы имеем несколько распространенных проблем.

![img_1.png](img_1.png)

Расскажу о них в порядке убывания важности для собесов и работы
...
![Пример кода CAS в Redis](/04_cache/assets/18-cas-php.png)
