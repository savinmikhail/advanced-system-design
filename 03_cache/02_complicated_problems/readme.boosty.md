...
### История 5: split-brain / кластеры

Split-brain — это ситуация, когда кластер Redis разваливается на две части , и обе считают себя главным узлом из-за сетевых проблем как правило
...
Чтобы избежать split-brain, используют: 
- quorum-системы (etcd/Zookeeper/Consul), 
- хранение критичных локов вне Redis, 
- ручной failover 
- или отказ от автоматической промоции мастера.
