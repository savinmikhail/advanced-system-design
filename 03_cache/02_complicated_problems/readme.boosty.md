...
Когда TTL у популярного кэша истекает, много запросов одновременно получают miss и штурмуют БД/Redis → всплеск нагрузки, рост latency, иногда каскадный отказ.
