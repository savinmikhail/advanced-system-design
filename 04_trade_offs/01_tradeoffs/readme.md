...
### 5.1 Resources Optimization Trade-offs
...
Под “ресурсами” здесь будем понимать не только CPU и память,
но и диск, сеть, деньги и даже мозги команды (сложность поддержки).

Resource optimization в реальной системе — это не “выжать 100% CPU”,
а выбор, _на что именно_ мы готовы тратить эти ресурсы,
чтобы уложиться в SLO по задержкам и доступности.
