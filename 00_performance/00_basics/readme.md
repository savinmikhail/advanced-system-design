## Часть 1. Производительность: базовая механика (latency, throughput, Little, хвосты)
...
#### 4. Почему среднее время ответа — плохой показатель 
...
#### 6. Почему в распределённых системах хвост раздувается
