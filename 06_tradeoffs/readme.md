...
- CPU
- RAM
- диск (ёмкость и скорость)
- сеть (пропускная способность и задержки между узлами)
- ресурс команды: сложность поддержки решений и время необходимое для этого

И все это превращается в деньги в конечном итоге
...
И это ровно то, что проверяют на архитектурных интервью: способность объяснить, какой компромисс выбран, чем за него платим и какие последствия принимаем. 
Дальше пройдёмся по типовым trade-off’ам
