...
1. Напоминание: что такое tail latency и p99.
2. Источники хвостов: железо, сеть, софт (только практические кейсы).
3. Как ретраи раздувают проблему: “всё ретраит” → retry storm.
4. Техники уменьшения хвоста:
...
5. Техники маскировки/обхода хвоста:
...
#### 1. Напоминание базовой картины (0:00–2:00)

> В прошлом видео мы договорились:
>
> * latency — это время ответа,
> * throughput — сколько запросов в секунду мы перевариваем,
> * их связь описывает закон Литтла,
> * среднее время ответа — фигня, смотрим на перцентили: p95, p99, p999.

Сейчас фокус **только на хвосте** — на p99 и дальше.
Задача: понять, почему эти “редкие” запросы вообще появляются и как с ними бороться.
