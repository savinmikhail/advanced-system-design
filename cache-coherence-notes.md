...
Перед тем как уходить в схемы, проговариваем боль: одного Redis‑слоя уже не хватает — хочется кэшировать и на edge, и в каждом сервисе, и на стороне БД, но с каждым новым уровнем становится сложнее понимать, где мы выигрываем по latency и hit‑rate, а где только плодим сложность и странные баги.
