...
### 4. Основные проблемы кэширования
   ...
   - Cache stampede/dogpile (thundering herd problem): TTL протух, и все одновременно лезут в БД.
...
6. **Сложные кейсы и баги**
   ...
   - Cache stampede/dogpile (thundering herd problem): когда ключ «протух», и сотни запросов одновременно идут в БД.
...
3. **Инциденты из продакшена (примерно 2–3 истории)**
   ...
   - Split-brain в кластере кэша → разные ответы для разных пользователей.
   - Для каждой истории:
