...
Глубокие детали (стратегии online-rebalance без даунтайма, сложные cross-shard оптимизации, внутренности CDC/логов)
— это уже опционально: полезно тем, кто реально админит/развивает шардированный кластер,
но для большинства backend-интервью не является обязательным.
