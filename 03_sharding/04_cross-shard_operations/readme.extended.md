...
#### 2.4.1. Практические стратегии оптимизации

##### 2.4.1.1. Data Locality — правильный shard key
...
##### 2.4.1.2. Денормализация — убрать JOIN
...
##### 2.4.1.3. Scatter-Gather (Fan-Out) (разбросать собрать)
...
##### 2.4.3.7. Кэширование cross-shard запросов
...
##### 2.4.3.9 Закрытие и мостик к следующей теме
