...
- синхронная репликация повышает latency записи - надо ждать пока реплики скажут, что записали данные
...
- от старых данных при необходимости можем избавиться просто DROP'ом партиции, а не DELETE'ом с последующим вакуумом, что дешевле
...
Например, гитхаб имел в среднем аж 950к запросов в секунду на своем MySQL кластере, прежде чем переходить к шардированию:
