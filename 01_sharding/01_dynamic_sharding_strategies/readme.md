Кидаю обновлённый файл про Dynamic Sharding целиком — с учётом идей из видео и нашей новой 2.0-части (ликбеза).

Можешь просто заменить старый `readme.md` этого раздела на текст ниже.
...
2. всё, что делилось “по остатку от деления”, живёт ровно до первого серьёзного роста.
...
**не просто “как один раз порезать”, а как жить, когда шарды нужно постоянно двигать и перевешивать.**
...
> Шардирование — это не “мы поделили данные и успокоились”.
> Шардирование — это про постоянное *перераспределение* данных.

Что ломает статическую схему:
