...
- где живёт routing (app / proxy / coordinator),
- и почему кросс-шард операции почти всегда дороже локальных.
...
Дальше разберём практику:
- как выбирать shard key,
- как бороться с hot keys и data skew,
- как устроен routing.
