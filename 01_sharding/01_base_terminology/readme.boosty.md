...
В первой части мы обсудили базовые термины: **партиционирование**, **шардирование** и **репликация** — и где каждое из них применяют.

Дальше я буду говорить уже не “в общем”, а про практику: 
- как выбирать **shard key**, 
- как бороться с **hot keys** и **data skew**,
- как сделать динамическую схему шардирования,
- и как ребалансировать layout шардов без даунтайма

Прежде чем двигаться дальше, определимся с базовой терминологией - что такое shard key, hot key, skew и routing
...
Домашней работой вам будет на своем стеке реализовать шардирование. 
Шардируйте таблицу например заказов по хешу, разбор будет на бусти. там же я покажу пример directory map шардинга
