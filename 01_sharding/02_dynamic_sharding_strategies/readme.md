# Блок 2.3. Dynamic Sharding стратегии (15 минут)
...
## Что такое Dynamic Sharding (1 минута)
...
## 2.3.1. Стратегии динамического шардирования (8–10 минут)
...
![Consistent Hashing: пример распределения ключей](img_1.png)
![Consistent Hashing: добавление нового шарда](img_2.png)
