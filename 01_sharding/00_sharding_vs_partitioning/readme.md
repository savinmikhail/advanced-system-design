...
![Разделение users на users\_core и users\_profile](assets/02-users-core-profile.png)
...
![Партиции events\_2025\_12 и events\_2026\_01](assets/04-events-range-partitions.png)
...
* **Дальше — разные классы хранилища для “горячего” и “холодного”.**
  ...
  * старые (холодные) — на более дешёвом/медленном storage;
  ...
  2. Создаём TABLESPACE’ы:
     ...
     ![Создание TABLESPACE fast\_ssd и slow\_hdd](assets/05-events-tablespace.png)
...
Глубокие детали шардирования, например dynamic sharding, rebalancing без downtime, cross-shard оптимизации — это отдельная большая тема, 
поэтому я разбираю её во второй части на Boosty
