...
#### 2.0.5. Ограничения партиционирования: UNIQUE/PK и цена вопроса
...
#### 2.0.6. Когда partitioning превращается в sharding
...
[//]: # (упомянуть что в кафке партиционирование может являтся шардированием, что терминология довольно плавающая, что некоторые системы например elasticsearch по умолчанию уже шардирован &#40;но там шарды это партиции скорее&#41;)
...
#### 2.0.7. Шардирование по регионам и мапа-шардов
...
#### 2.0.8. Шардирование на уровне БД: Citus и друзья
...
#### 2.0.9. Мини-резюме перед углублением
